...
python -m ltx_pipelines.ti2vid_two_stages \
  --checkpoint-path /mnt/disk1/models/LTX-2/ltx-2-19b-dev.safetensors \
  --distilled-lora  /mnt/disk1/models/LTX-2/ltx-2-19b-distilled-lora-384.safetensors 0.8 \
  --spatial-upsampler-path /mnt/disk1/models/LTX-2/ltx-2-spatial-upscaler-x2-1.0.safetensors \
  --gemma-root /mnt/disk1/models/LTX-2 \
  --prompt "In a spacious living room, a blue sofa is in the center. The sofa is slowly getting taller." \
  --output-path 01_cake_enlarge_hq.mp4 \
  --height 768 --width 1024 --num-frames 97 --frame-rate 24 \
  --seed 100 \
  --streaming-prefetch-count 24 
